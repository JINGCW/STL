...
--local games_module=require("libExample")
--local games_module=package.loadlib("libgames.dll","this_object__Object")
--print(games_module().hello())

--local example_module=require("libExample")
--
--local example_object=example_module.ExampleObject()
--print(example_object)

local target=package.loadlib("./libExample.dll",'*')
print(target)
print(target.ExampleObject())
